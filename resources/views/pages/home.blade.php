<x-app-layout>
        ...
        <div class="ms-container lg:max-w-3xl lg:mx-auto">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
                <div class="flex flex-col items-center">
                    <p class="text-accent-dark font-semibold text-xl md:text-2xl xl:text-3xl mb-2"> <strong> 50000+ </strong> </p>
                    <p class="uppercase text-accent-dark text-sm"> Hampers Delivered </p>
                </div>
                <div class="flex flex-col items-center">
                    <p class="text-accent-dark font-semibold text-xl md:text-2xl xl:text-3xl mb-2"> <strong> 50+ </strong> </p>
    ...
    <section id="highlights" class="py-12">
        <div class="ms-container text-center lg:max-w-3xl lg:mx-auto">
            <h2 class="text-primary font-semibold text-lg sm:text-xl lg:text-2xl xl:text-3xl mb-4"> What Sets Us Apart </h2>
            <p class="mb-6"> 
                At Rad we don't create hampers, we create joy! Your reputation and goodwill is our responsibility, as we give 
                utmost attention to detail and make sure the corporate gifts we make for your business are of the best value 
                and ensure recipient satisfaction. Rad brings your thoughts into action because <strong> it's the Thought that counts </strong>. 
                We are a comprehensive gifting solution provider that takes care in sourcing best quality products from reliable vendors 
                tagged with eco friendly packaging and personalisation. 
            </p>
        </div>
        <div class="text-center lg:max-w-4xl lg:mx-auto">
            <div class="grid grid-cols-1 gap-x-1 gap-y-4 sm:grid-cols-2 sm:gap-x-2 sm:gap-y-2 md:gap-x-4 lg:grid-cols-4 lg:gap-x-6 justify-center">
                <div class="text-center">
                    <img class="w-24 h-24 object-contain object-center mx-auto" src="{{ asset('images/icons/no-moq.png') }}" alt="No Minimum Order Quantity">
                    <p class="uppercase text-primary font-semibold leading-relaxed"> No Minimum Order Quantity </p>
                </div>
                <div class="text-center">
                    <img class="w-24 h-24 object-contain object-center mx-auto" src="{{ asset('images/icons/on-time-delivery.png') }}" alt="On time delivery">
                ...
                <div class="text-center">
                    <img class="w-24 h-24 object-contain object-center mx-auto" src="{{ asset('images/icons/customer-support.png') }}" alt="">
                    <p class="uppercase text-primary font-semibold leading-relaxed"> Exceptional Customer Service </p>
                </div>
                <div class="text-center">
                    <img class="w-24 h-24 object-contain object-center mx-auto" src="{{ asset('images/icons/flexible-pricing.png') }}" alt="flexible-pricing">
                    <p class="uppercase text-primary font-semibold leading-relaxed"> Flexible Pricing </p>
                </div>
                <div class="text-center">
                    <img class="w-24 h-24 object-contain object-center mx-auto" src="{{ asset('images/icons/database-management.png') }}" alt="">
    ...
    <section id="features" class="py-12">
        <div class="ms-container lg:max-w-4xl lg:mx-auto">
            <div class="bg-accent grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 items-center gap-4 px-4 py-8">
                ...
                <div class="text-white">
                    <a class="bg-white rounded-full px-6 py-3 text-accent hover:bg-primary hover:text-white" href="{{route('pages.contact')}}"> Curate Your Hamper </a>
                </div>
            </div>
        </div>
    </section>
    <section id="reviews" class="py-12">
        <div class="ms-container grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
            <div class="px-4 py-4 border border-solid border-gray-300">
                ...
                <p class="mb-6"> Can't find a better partner for creating customised gifting solutions for your corporate gifting needs. Worked on multiple occasions for different types of gifting needs for our company and really appreciated their flexibility to work around our needs, creative collaboration and they ended up exceeding expectations every time. Highly recommended. </p>
            ...
            <div class="px-4 py-4 border border-solid border-gray-300">
                ...
                <p class="mb-6"> Rad gifts are one stop solution for corporate gifts. We reached the RAD for a corporate gift and they suggested multiple options. We had an excellent experience with them. Below is my rating for their service. Quality: 5/5,  Turn around time : 5/5, Delivery: very smooth, delivery process 5/5. Overall I would rate 5* for Rad team </p>
            ...
            <div class="px-4 py-4 border border-solid border-gray-300">
                ...
                <p class="mb-6"> Our team is super happy with the Diwali hamper . Though it was last minute order you made sure everything was perfect. Thank you so much . Will strongly recommend your work. And you'll be Rocketlane's fav vendor. </p>
